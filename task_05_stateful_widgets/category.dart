...
class Category extends StatelessWidget {
  ...
  void _navigateToConverter(BuildContext context) {
    ...
    // Push a new MaterialPageRoute with the input parameters to build a unit converter for the correct category
    Navigator.of(context).push(MaterialPageRoute<Null>(
      builder: (BuildContext context) {
        return Scaffold( // Each screen is a Widget
          appBar: AppBar(
            elevation: 1.0,
            title: Text(
              name,
          ...
          // This prevents the onscreen keyboard from affecting the size of the screen, and space give to widgets.
